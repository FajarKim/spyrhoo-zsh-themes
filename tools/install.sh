...
setup_theme() {
  ...
  sleep 0.5
  echo "${BLUE}Installing theme Spyrhoo${RESET}"
  sleep 1.5
  git clone --depth=1 https://github.com/FajarKim/spyrhoo-zsh-theme.git ${ZSH_CUSTOM:-$HOME/.oh-my-zsh/custom}/themes/spyrhoo || {
    fmt_error "git clone of spyrhoo-zsh-theme repo failed"
    exit 1
  }
